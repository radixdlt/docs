...
We begin this article by providing an introduction on why we need to deliver buildability in our platform. We'll focus on how DApps have been built until now, and the three types of DApps \([protocol level](buildability.md#protocol-level-dapps), [client-side](buildability.md#client-side-dapps) and [smart contracts](buildability.md#smart-contract-based-dapps)\) commonly used.
...
* [Peer-to-Peer transactions ](../../developer/javascript-client-library-guide/quick-start.md)
* [Secure messaging](../../developer/javascript-client-library-guide/quick-start.md)

Our roadmap detailing progress on further functionality can be viewed [here](https://www.radixdlt.com/roadmap). Those looking to get started building on Radix can find our developer section [here](../../developer/live-platform-overview.md).
