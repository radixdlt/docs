...
The Radix DLT software stack is composed of a set of specialized docker images, with different roles. The minimal \(basic\) `radixdlt` system contains the following components \(docker images\):
...
services:
  core:
    image: radixdlt/radixdlt-core:alphanet2
    init: true
    ...
    environment:
      ...
      CORE_NETWORK_SEEDS: "168.61.34.193,168.62.51.26,13.66.168.246,13.66.213.50,40.91.210.108,104.45.18.105,13.67.77.243,13.67.90.17,191.239.255.182,191.239.245.47"
  ...
  nginx:
    ...
    logging:
      options:
        ...
        max-file: "30"
  nns:
    image: radixdlt/nns-client:alphanet2
    restart: unless-stopped
    logging:
      options:
        max-size: "1m"
